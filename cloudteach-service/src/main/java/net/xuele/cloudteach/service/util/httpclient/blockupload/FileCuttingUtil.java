...
public class FileCuttingUtil {
     ...
     * @throws IOException
     */
    public List<String> splitBySizeSync(String fileName, int byteSize) throws IOException {
        ...
        for (int i = 0; i < count; i++) {
            String partFileName = fileName + "." + leftPad((i + 1) + "", countLen, '0') + ".part";
            new SplitRunnable(byteSize, i * byteSize, partFileName, file).run();
            parts.add(partFileName);
        }
        return parts;
    ...
    public void mergePartFiles(String dirPath, String partFileSuffix,
        ...
        ArrayList<File> partFiles = FileCuttingUtil.getDirFiles(dirPath,
                partFileSuffix);
