...
import net.xuele.cloudteach.web.wrapper.TeacherWorkFileDetailWrapper;
 ...
 */
@Controller
@RequestMapping(value = "exercise/work/student")
public class ExerciseWorkStuController {

    private static org.slf4j.Logger logger = LoggerFactory.getLogger(ExerciseWorkStuController.class);
    ...
    public String queryMyWorkDetail(ModelMap map, String workId) {
        ...
        return "workmanage/student/writeExerciseWork";
    }
    ...
    public String exerciseWorkCommunication(ModelMap map, String workId) {
        ...
        return "workmanage/student/exerciseWorkCommunication";
    }
     ...
     * @date 2015/07/12
     */
    @RequestMapping(value = "handInMyExerciseWork")
    @ResponseBody
    public AjaxResponse handInMyExerciseWork(String workId, String answerContext, String workFileJSON) {
