 ...
 */
@Controller
@RequestMapping(value = "voice/work/student")
public class VoiceWorkStuController {
    ...
    public String queryMyWorkDetail(ModelMap map, String workId) {
        ...
        return "workmanage/student/writeVoiceWork";
    }
    ...
    public String exerciseWorkCommunication(ModelMap map, String workId) {
        ...
        return "workmanage/student/voiceWorkCommunication";
    }
     ...
     * @date 2015/07/12
     */
    @RequestMapping(value = "handInMyVoiceWork")
    @ResponseBody
    public AjaxResponse handInMyPrepWork(String workId, String answerContext, int sysScore, String workFileJSON) {
        ...
        teacherWorkItemAnswerDTO.setSysScore(sysScore);
