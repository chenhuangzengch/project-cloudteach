 ...
 * @date 2015/7/7 0002
 */
public class SynclassWorkWrapper {
    ...
    private List<SynclassWorkGameWrapper>  wrapperList;
    ...
    public List<SynclassWorkGameWrapper> getWrapperList() {
        return wrapperList;
    }

    public void setWrapperList(List<SynclassWorkGameWrapper> wrapperList) {
