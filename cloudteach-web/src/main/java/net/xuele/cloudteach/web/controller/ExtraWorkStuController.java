 ...
 */
@Controller
@RequestMapping(value = "extra/work/student")
public class ExtraWorkStuController {
    ...
    public String queryMyWorkDetail(ModelMap map, String workId) {
        ...
        return "workmanage/student/writeExtraWork";
    }
    ...
    public String extraWorkCommunication(ModelMap map, String workId) {
        ...
        logger.info("[课外作业完成人数：" + subStuNum + "]");
        ...
        return "workmanage/student/extraWorkCommunication";
    }
     ...
     * @date 2015/07/12
     */
    @RequestMapping(value = "handInMyextraWork")
    @ResponseBody
    public AjaxResponse handInMyExtraWork(String workId, String answerContext, String workFileJSON) {
