...
import net.xuele.cloudteach.dto.GuidanceItemDTO;
 ...
 * @date 2015/7/2 0002
 */
public class GuidanceItemWrapper {
    /**
     * 预习项ID
     */
    ...
    /**
     * 初始化
     * @param guidanceItemDTO
     */
    public GuidanceItemWrapper(GuidanceItemDTO guidanceItemDTO) {
        BeanUtils.copyProperties(guidanceItemDTO, this);
        //TODO 长度为3000的描述类信息，在列表中显示后台截取指定长度后传到前端
        this.setContext(guidanceItemDTO.getContext()/** .substring(0) */);
    }
