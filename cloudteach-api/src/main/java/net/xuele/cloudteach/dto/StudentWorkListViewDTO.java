 ...
 */
public class StudentWorkListViewDTO implements Serializable {

    private static final long serialVersionUID = 5766646310006505181L;
    ...
    public String toString() {
        return "StudentWorkListViewDTO{" +
                ...
                ", magicWorkChallengeTimesViewDTO=" + magicWorkChallengeTimesViewDTO +
                ", magicWorkAnswerFilesDTOList=" + magicWorkAnswerFilesDTOList +
                ", synclassWorkPlayViewDTOList=" + synclassWorkPlayViewDTOList +
