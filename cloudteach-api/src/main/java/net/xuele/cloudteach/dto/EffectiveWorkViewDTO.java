...
/**
 * EffectiveWorkViewDTO
 * 作业管理-进行中的作业
 * @author duzg
 * @date 2015/7/8 0002
 */
public class EffectiveWorkViewDTO implements Serializable {
    private static final long serialVersionUID = 3482860843860859204L;
