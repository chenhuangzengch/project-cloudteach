...
/**
 * ExerciseWorkClassDTO
 *
 * @author duzg
 * @date 2015/7/7 0002
 */
public class ExerciseWorkClassDTO implements Serializable {
    @Override
    public String toString() {
        return "ExerciseWorkClassDTO{" +
    ...
    private static final long serialVersionUID = -195407000845808866L;
