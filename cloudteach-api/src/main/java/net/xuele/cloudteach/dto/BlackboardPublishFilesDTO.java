...
public class BlackboardPublishFilesDTO implements Serializable {
    private static final long serialVersionUID = -5292252796794596610L;
    /**
     * 板书发布附件ID
     */
    ...
    public String toString() {
        return "BlackboardPublishFilesDTO{" +
                "fileId='" + fileId + '\'' +
