...
public class BlackboardPublishClassDTO implements Serializable {
    private static final long serialVersionUID = 3319536031365153630L;
    /**
     * 板书发布班级ID
     */
    ...
    public String toString() {
        return "BlackboardPublishClassDTO{" +
                "blackboardClassId='" + blackboardClassId + '\'' +
