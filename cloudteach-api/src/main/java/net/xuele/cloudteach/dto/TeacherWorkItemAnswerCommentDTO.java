 ...
 */
public class TeacherWorkItemAnswerCommentDTO implements Serializable {
    private static final long serialVersionUID = 8774141303899234286L;
    /**
     * 评论id
     */
    ...
    public String toString() {
        return "TeacherWorkItemAnswerCommentDTO{" +
                "commentId='" + commentId + '\'' +
                ", answerId='" + answerId + '\'' +
                ", userId='" + userId + '\'' +
                ", userType=" + userType +
