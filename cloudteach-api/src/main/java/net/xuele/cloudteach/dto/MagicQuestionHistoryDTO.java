...
/**
 * MagicQuestionHistoryDTO
 * 提分宝题库题目操作历史记录
 * @author duzg
 * @date 2015/7/13 0002
 */
public class MagicQuestionHistoryDTO implements Serializable {
    private static final long serialVersionUID = 3367340194113559620L;
    /**
     * 唯一主键
     */
    ...
    public String toString() {
        return "MagicQuestionHistoryDTO{" +
                "hisId='" + hisId + '\'' +
                ", opUser='" + opUser + '\'' +
                ", opDetail='" + opDetail + '\'' +
