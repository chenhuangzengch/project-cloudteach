...
public class TeachCoursewaresSharePraiseDTO implements Serializable {
    private static final long serialVersionUID = -7166003161891901294L;
    /**
     * 分享授课课件ID
     */
    ...
    public String toString() {
        return "TeachCoursewaresSharePraiseDTO{" +
                "shareId='" + shareId + '\'' +
                ", userId='" + userId + '\'' +
