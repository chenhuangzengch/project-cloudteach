...
/**
 * ExerciseWorkAnswerPraiseDTO
 *
 * @author duzg
 * @date 2015/7/7 0002
 */
public class ExerciseWorkAnswerPraiseDTO implements Serializable {
    private static final long serialVersionUID = 6083907987602897986L;
    ...
    public String toString() {
        return "ExerciseWorkAnswerPraiseDTO{" +
                "answerId='" + answerId + '\'' +
                ", userId='" + userId + '\'' +
                ", userType=" + userType +
