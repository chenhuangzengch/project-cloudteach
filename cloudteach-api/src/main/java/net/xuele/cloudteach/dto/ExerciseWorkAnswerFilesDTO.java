...
/**
 * ExerciseWorkAnswerFilesDTO
 *
 * @author duzg
 * @date 2015/7/7 0002
 */
public class ExerciseWorkAnswerFilesDTO implements Serializable {
    private static final long serialVersionUID = 3654707839972938751L;
    ...
    public String toString() {
        return "ExerciseWorkAnswerFilesDTO{" +
