...
public class BlackboardPublishStudentDTO implements Serializable {
    private static final long serialVersionUID = 7255549173680958247L;
    /**
     * 板书发布学生ID
     */
    ...
    public String toString() {
        return "BlackboardPublishStudentDTO{" +
                "blackboardUserId='" + blackboardUserId + '\'' +
                ", userId='" + userId + '\'' +
